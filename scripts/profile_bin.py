...
def main():
    ap = argparse.ArgumentParser(description="Profile a QNN context binary via AI Hub")
    ap.add_argument("ctx_bin", help="Path to context binary")
